public class CalculatriceSimple { //initialisation de la classe test
    ...
    public static void main(String[] args) { //méthode main
        ...
        Operation o1 = new Addition(n1, n2); //création de l'objet o1 de type Operation (qu'on pourrait aussi mettre de type Addition)
        System.out.println(o1); //appel de la méthode toString de la classe Addition

        Operation o2 = new Soustraction(n1, n2); //création de l'objet o2 de type Operation (qu'on pourrait aussi mettre de type Soustraction)
        System.out.println(o2); //appel de la méthode toString de la classe Soustraction

        Operation o3 = new Multiplication(n1, n2); //création de l'objet o3 de type Operation (qu'on pourrait aussi mettre de type Multiplication)
        System.out.println(o3); //appel de la méthode toString de la classe Multiplication

        Operation o4 = new Division(n1, n2); //création de l'objet o4 de type Operation (qu'on pourrait aussi mettre de type Division)
        ...
        try { //on essaie d'exécuter les instructions du bloc try tant qu'aucune erreur/exception n'est détectée
            Operation o5 = new Division(n1, n3); //création de l'objet o5 de type Operation ((qu'on pourrait aussi mettre de type Division)
